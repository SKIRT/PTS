...
parser.add_argument('--plotprogress', action='store_true', help='after a job finished, plot the progress of the different processes')
...
plotprogress = args.plotprogress
...
test.run(maxnodes, minnodes, manual, keepoutput, plotprogress)
