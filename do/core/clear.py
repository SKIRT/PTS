...
parser.add_argument("--status", type=string_list, help="clear/stop all simulations with these particular statuses")
parser.add_argument("--ids", type=simulation_ids, help="clear/stop the simulations with these ID's")
