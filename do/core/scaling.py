...
#parser.add_argument("--progress", action="store_true", help="extract and plot progress information from finished simulations")
#parser.add_argument("--timeline", action="store_true", help="extract and plot timeline information from finished simulations")
#parser.add_argument("--memory", action="store_true", help="extract and plot memory information from finished simulations")
