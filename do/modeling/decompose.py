...
## \package pts.do.modeling.decompose Run the bulge-disk decomposition for the galaxy as part of the radiative
#  transfer modeling.
...
decomposer = GalaxyDecomposer(config.get_settings())
