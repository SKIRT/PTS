...
## \package pts.do.modeling.analyse_colours Analyse the FIR colours of the best fitting model.
...
# Create a ColourAnalyser object
analyser = ColourAnalyser.from_arguments(arguments)
