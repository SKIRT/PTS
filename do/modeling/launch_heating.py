...
from pts.modeling.analysis.heatingcontributionlauncher import HeatingContributionLauncher
...
# Create a HeatingContributionLauncher object
launcher = HeatingContributionLauncher.from_arguments(arguments)
