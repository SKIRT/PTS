...
## \package pts.modeling.html.fluxes Contains the FluxesPageGenerator class.
...
class FluxesPageGenerator(HTMLPageComponent):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(FluxesPageGenerator, self).__init__(*args, **kwargs)
    ...
    def setup(self, **kwargs):
        ...
        super(FluxesPageGenerator, self).setup(**kwargs)
