...
definition.add_optional("factor_range", "real_range", "range (min,max) of values for the factor to which the disk ellipse should be scaled to obtain the truncation region", "0.5>1.5", convert_default=True)
