...
## \package pts.magic.region.epanda Contains the EpandaRegion class and subclasses.
...
class EpandaRegion(Region):
    ...
    def __init__(self, center, start_angle, stop_angle, nangle, inner, outer, nradius, **kwargs):
        ...
        super(EpandaRegion, self).__init__(**kwargs)

# -----------------------------------------------------------------

class PixelEpandaRegion(EpandaRegion, PixelRegion):
    ...
    def __init__(self, center, start_angle, stop_angle, nangle, inner, outer, nradius, **kwargs):
        ...
        # Call the constructor of EpandaRegion class
        EpandaRegion.__init__(self, center, start_angle, stop_angle, nangle, inner, outer, nradius, **kwargs)

# -----------------------------------------------------------------

class SkyEpandaRegion(EpandaRegion, SkyRegion):
...
class PhysicalVectorRegion(EpandaRegion, PhysicalRegion):
