...
## \package pts.dustpedia.welcome Contains a function that prints a welcome message.
...
def welcome(width=50, prefix="    "):
    ...
    fmt.print_centered_around_border("Welcome to PTS/DustPedia, " + introspection.username(), "#", prefix=prefix, length=width)
