...
## \package pts.evolve.allele In this module, there are the :class:`GAllele.GAlleles` class (which is the
#  class that holds the allele types) and all the allele types to use with the supported chromosomes.
